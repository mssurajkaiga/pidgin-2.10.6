...
#line 106 "Conversation.xs"
	GList *l;
#line 109 "Conversation.c"
#line 108 "Conversation.xs"
	for (l = purple_get_conversations(); l != NULL; l = l->next) {
		XPUSHs(sv_2mortal(purple_perl_bless_object(l->data, "Purple::Conversation")));
	}
#line 114 "Conversation.c"
	PUTBACK;
	return;
    }
}
...
XS(XS_Purple_find_conversation_with_account); /* prototype to pass -Wmissing-prototypes */
XS(XS_Purple_find_conversation_with_account)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Purple__Conversation__IM_send_with_flags); /* prototype to pass -Wmissing-prototypes */
XS(XS_Purple__Conversation__IM_send_with_flags)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_Purple__Conversation__Chat_send_with_flags); /* prototype to pass -Wmissing-prototypes */
XS(XS_Purple__Conversation__Chat_send_with_flags)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
