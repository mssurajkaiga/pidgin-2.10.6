...
DIST_COMMON = README $(am__configure_deps) $(noinst_HEADERS) \
	...
	$(srcdir)/pidgin.apspec.in $(srcdir)/pidgin.spec.in \
	$(top_srcdir)/configure \
	$(top_srcdir)/libpurple/plugins/perl/common/Makefile.PL.in \
	$(top_srcdir)/pidgin/plugins/perl/common/Makefile.PL.in \
...
CONFIG_CLEAN_FILES = Doxyfile pidgin.apspec \
	pidgin/plugins/perl/common/Makefile.PL \
	libpurple/plugins/perl/common/Makefile.PL pidgin.spec
...
ACLOCAL = ${SHELL} /home/thedarkknight/development/pidgin-2.10.6/missing --run aclocal-1.11
ALLOCA = 
...
AR = ar
AUTOCONF = ${SHELL} /home/thedarkknight/development/pidgin-2.10.6/missing --run autoconf
AUTOHEADER = ${SHELL} /home/thedarkknight/development/pidgin-2.10.6/missing --run autoheader
AUTOMAKE = ${SHELL} /home/thedarkknight/development/pidgin-2.10.6/missing --run automake-1.11
...
DBUS_LIBS = -ldbus-glib-1 -ldbus-1 -lpthread -lrt -lgobject-2.0 -lglib-2.0  
...
DUMPBIN = 
DYNALOADER_A = 
DYNAMIC_PRPLS = bonjour gg irc jabber msn myspace mxit novell oscar sametime  simple yahoo zephyr
ECHO_C = 
ECHO_N = -n
ECHO_T = 
EGREP = /bin/grep -E
...
EXEEXT = 
FARSTREAM_CFLAGS = -pthread -I/usr/include/farstream-0.1 -I/usr/include/gstreamer-0.10 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/libxml2  
FARSTREAM_LIBS = -pthread -lfarstream-0.1 -lgstbase-0.10 -lgstreamer-0.10 -lgobject-2.0 -lgmodule-2.0 -lgthread-2.0 -lrt -lxml2 -lglib-2.0  
FGREP = /bin/grep -F
GADU_CFLAGS = 
GADU_LIBS = 
...
GNUTLS_LIBS = 
GREP = /bin/grep
GSTINTERFACES_CFLAGS = -pthread -I/usr/include/gstreamer-0.10 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/libxml2  
GSTINTERFACES_LIBS = -pthread -lgstinterfaces-0.10 -lgstreamer-0.10 -lgobject-2.0 -lgmodule-2.0 -lgthread-2.0 -lrt -lxml2 -lglib-2.0  
...
GTKSPELL_CFLAGS = -pthread -I/usr/include/gtk-2.0 -I/usr/lib/x86_64-linux-gnu/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/pango-1.0 -I/usr/include/gio-unix-2.0/ -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12 -I/usr/include/gtkspell-2.0  
GTKSPELL_LIBS = -lgtkspell -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lcairo -lpango-1.0 -lfreetype -lfontconfig -lgobject-2.0 -lglib-2.0  
...
LIBOBJS = 
LIBPERL_A = 
LIBS = -lutil -lpthread -lm -lnsl -lresolv 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/thedarkknight/development/pidgin-2.10.6/missing --run makeinfo
MANIFEST_TOOL = :
MEANWHILE_CFLAGS = -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/meanwhile  
...
NSS_LIBS = -lnss3 -lnssutil3 -lsmime3 -lssl3 -lplds4 -lplc4 -lnspr4 -lpthread -ldl  
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
OTOOL64 = 
...
PANGO_CFLAGS = -pthread -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include  
...
PERL_LIBS = -Wl,-E -fstack-protector -L/usr/local/lib -L/usr/lib/perl/5.14/CORE -lperl -ldl -lm -lpthread -lcrypt
...
PY_LIBS = -L/usr/lib/python2.7/config -lpython2.7
RANLIB = ranlib
SASL_LIBS = 
SED = /bin/sed
SET_MAKE = 
...
STATIC_PRPLS = 
STRIP = strip
TCL_CFLAGS = -I/usr/include/tcl8.5 -I/usr/include -fno-strict-aliasing
TCL_LIBS = -L/usr/lib -ltcl8.5
TK_LIBS = -L/usr/lib -ltk8.5
USE_NLS = yes
VERSION = 2.10.6
X11_CFLAGS =  
X11_LIBS = -lX11  
...
XMKMF = 
XSLTPROC = true
XSS_LIBS =   -lSM -lICE -lX11 -lXext   -lXss
X_CFLAGS = 
X_EXTRA_LIBS = 
X_LIBS = 
X_PRE_LIBS =  -lSM -lICE
...
ZEPHYR_LDFLAGS = 
ZEPHYR_LIBS = 
abs_builddir = /home/thedarkknight/development/pidgin-2.10.6
abs_srcdir = /home/thedarkknight/development/pidgin-2.10.6
abs_top_builddir = /home/thedarkknight/development/pidgin-2.10.6
abs_top_srcdir = /home/thedarkknight/development/pidgin-2.10.6
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
pidgin.apspec: $(top_builddir)/config.status $(srcdir)/pidgin.apspec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
pidgin/plugins/perl/common/Makefile.PL: $(top_builddir)/config.status $(top_srcdir)/pidgin/plugins/perl/common/Makefile.PL.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
libpurple/plugins/perl/common/Makefile.PL: $(top_builddir)/config.status $(top_srcdir)/libpurple/plugins/perl/common/Makefile.PL.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
pidgin.spec: $(top_builddir)/config.status $(srcdir)/pidgin.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	info-am install install-am install-appsDATA install-data \
